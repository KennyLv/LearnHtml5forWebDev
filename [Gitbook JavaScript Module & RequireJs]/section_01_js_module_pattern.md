...
```
Notice that we’ve declared a global module named MODULE, with two public properties: a method named ** MODULE.moduleMethod ** and a variable named ** MODULE.moduleProperty**.
