...
function YYMMDD(){ 
    ...
    if (Today.getDay() == 0) cl = '<font color="#c00000" STYLE="font-size:9pt;">'; 
    if (Today.getDay() == 6) cl = '<font color="#00c000" STYLE="font-size:9pt;">';
...
function keleyirili(){
var title="可乐意日历";
var url="http://www.keleyi.com/tools/rili/";
if (window.sidebar) window.sidebar.addPanel(title, url,"http://www.keleyi.com");
